=== Plugin Name ===
Contributors: f13dev
Donate link: http://f13dev.com/wordpress-plugin-lastfm-album-shortcode/
...
1. An example showing the results of the shortcode [album artist="Queen" album="Greatest Hits"]
